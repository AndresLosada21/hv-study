    ...
    )
{
    ...
    //
    // Cleanup do subsistema de stealth
    //
    ShvStealthCleanup();
    ...
    )
{
    ...
    //
    // Inicializa o subsistema de anti-detection (stealth).
    // Faz cache dos MSRs e calcula valores "limpos".
    //
    ...
    // Indicate success.
    //
    ShvOsDebugPrint("The SHV has been installed (with stealth).\n");
